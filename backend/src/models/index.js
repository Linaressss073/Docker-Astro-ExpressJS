...
const Habitaciones = sequelize.define('Habitaciones', {
  ...
  descripcion: {
    type: DataTypes.TEXT  // mejor TEXT para descripciones largas
  },
  precio: {
    type: DataTypes.DECIMAL(10, 2),
    allowNull: false
  ...
  servicios: {
    type: DataTypes.TEXT, // Guardamos JSON stringify aquí
    allowNull: true,
    get() {
...
// Función para insertar habitaciones iniciales (seed)
const seedHabitaciones = async () => {
  try {
    const count = await Habitaciones.count();
    if (count === 0) {
      await Habitaciones.bulkCreate([
        {
          ...
          capacidad: 4,
          cama: 'King XL Bed',
          servicios: ["Desayuno Gourmet", "Baño Privado con Jacuzzi", "WiFi de Alta Velocidad", "TV de Pantalla Plana 65\"", "Minibar Premium", "Servicio de Mayordomo"],
          imagen: 'room1.jpg',
          estrellas: 5,
          tipo: 'Luxury Suite'
        },
        {
          ...
          capacidad: 2,
          cama: 'Queen Beds',
          servicios: ["Desayuno", "Baño Privado", "WiFi Gratuito", "TV de Pantalla Plana", "Balcón"],
          imagen: 'room2.jpg',
          estrellas: 4,
          tipo: 'Superior'
        },
        {
          ...
          capacidad: 2,
          cama: 'King Bed',
          servicios: ["Baño Privado", "WiFi", "TV", "Cocina Equipada", "Lavandería"],
          imagen: 'room3.jpg',
          estrellas: 3,
          tipo: 'Apartment'
        },
        {
          ...
          servicios: ["Desayuno", "Dos Baños", "WiFi", "TV en cada habitación", "Aire Acondicionado"],
          imagen: 'room3.jpg',
          estrellas: 4,
          tipo: 'Family'
        },
        {
          ...
          capacidad: 2,
          cama: 'King Bed',
          servicios: ["Desayuno", "Baño Privado", "WiFi", "Smart TV", "Terraza Privada"],
          imagen: 'room1.jpg',
          estrellas: 4,
          tipo: 'Suite'
        },
        {
          ...
          capacidad: 1,
          cama: 'Single Bed',
          servicios: ["Baño Privado", "WiFi", "TV"],
          imagen: 'room2.jpg',
          estrellas: 3,
          tipo: 'Economy'
        },
        {
          ...
          capacidad: 2,
          cama: 'Queen Bed',
          servicios: ["Desayuno", "Baño Privado", "WiFi", "TV", "Vistas al Mar"],
          imagen: 'room3.jpg',
          estrellas: 5,
          tipo: 'Premium'
        },
        {
          ...
          capacidad: 2,
          cama: 'King Bed',
          servicios: ["Desayuno Exclusivo", "Baño de Lujo", "WiFi de Alta Velocidad", "Smart TV 70\"", "Minibar", "Balcón Panorámico"],
          imagen: 'room3.jpg',
          estrellas: 5,
          tipo: 'Penthouse'
        }
      ...
      console.log('⚠️ Habitaciones ya existen, no se insertaron duplicados');
    }
  } catch (error) {
